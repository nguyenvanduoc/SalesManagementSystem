...
try {
    $conn.Open()
    $sqlPath = "c:\Users\duoc0\OneDrive\Desktop\WEB_QLBH\QuanLyBanHang\SalesManagementSystem\SalesManagementSystem\App_Data\sp_BaoCao_DoiChieuCongNoKhachHang.sql"
    ...
    Write-Output "SUCCESS: Created sp_BaoCao_DoiChieuCongNoKhachHang procedure!"
} catch {
