...
GO
CREATE PROCEDURE sp_KT_PhieuThu_GetById
    @ID INT
AS
BEGIN
    SET NOCOUNT ON;
...
GO
CREATE PROCEDURE sp_KT_PhieuThu_LoadCongNoKhachHang
    @IDKhachHang INT
AS
BEGIN
    SET NOCOUNT ON;
...
GO
CREATE PROCEDURE sp_KT_PhieuThu_Delete
    @ID INT
AS
BEGIN
